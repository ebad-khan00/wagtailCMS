...
from myproject.news.models import ArticlePage, NewsListingPage
from myproject.utils.models import ArticleTopic, AuthorSnippet
...
class LatestArticlesFeedTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        from myproject.news.feeds import LatestArticlesFeed
